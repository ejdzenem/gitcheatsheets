...
If you're getting started with Git, a great place to learn the basic commands is the [Git Cheat sheet](https://Gitlab.Gitlab.io/training-kit/). It's translated into many languages, [open source as a part of the `Gitlab/training-kit` repository](https://Gitlab.com/Gitlab/training-kit), and a great starting place for the fundamentals on the command line.
